#!/bin/bash
# Generate comprehensive Docker learning project

set -e

BASE="/Users/avtandilgokadze/Learning/docker-learning"

echo "🐳 Generating Docker Learning Project..."
echo ""
...
# Done message
echo ""
echo "📚 Docker learning project created!"
echo ""
echo "Next: Run the detailed generation script to create all example files..."
echo "This script created the base structure and README.md"
echo ""
echo "To complete the project, you'll need additional files which"
echo "Claude will create individually for quality and completeness."
MAINREADME
chmod +x "$BASE/generate-docker-learning.sh"

echo "Script created at: $BASE/generate-docker-learning.sh"
